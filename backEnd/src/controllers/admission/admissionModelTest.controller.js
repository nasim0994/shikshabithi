const Model = require("../../models/admission/admissionModelTest.model");
...
exports.get = async (req, res) => {
  ...
  try {
    ...
    const result = await Model.find(query).populate("university set mcqs");
...
exports.getSingle = async (req, res) => {
  ...
  try {
    const result = await Model.findById(id).populate("university set mcqs");
    res.status(200).json({
      success: true,
      message: "Model Test get success",
      data: result,
