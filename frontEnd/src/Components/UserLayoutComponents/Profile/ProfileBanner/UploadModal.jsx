...
import { useUpdateProfileBannerMutation } from "../../../../Redux/api/user/profileApi";
...
export default function UploadModal({ modal, setModal }) {
  ...
  const [updateProfileImage, { isLoading }] = useUpdateProfileBannerMutation();
  ...
  const handleUpdate = async (e) => {
    ...
    if (res?.data?.success) {
      toast.success("Profile Banner update success");
      setModal(false);
      setError("");
    ...
    <div className={`overlay ${modal && "overlay_show"}`}>
      ...
      >
        ...
        <div className="text-center">
          <h2 className="text-xl font-medium text-neutral">Upload Banner</h2>
