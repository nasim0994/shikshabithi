...
export default function BoardMcq() {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useGetBoardMcqsQuery({ ...query });
  const boardMcqs = boardMcq?.data;
      ...
      <section className="">
        <div className="rounded overflow-hidden">
          <div className="bg-primary text-base-100 text-center py-4">
            ...
            <p className="text-sm">All Question - ({boardMcq?.meta?.total})</p>
          </div>
          ...
          {boardMcq?.meta?.pages > 1 && (
            <Pagination
              pages={boardMcq?.meta?.pages}
