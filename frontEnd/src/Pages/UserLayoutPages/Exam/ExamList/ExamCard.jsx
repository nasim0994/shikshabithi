...
export default function ExamCard({ modelTest, i, packageData }) {
    ...
    <div className="bg-base-100 rounded relative">
      <div className="p-3">
        ...
        <div className="flex items-center gap-4">
          <Link to={`/exam/modeltest/${modelTest?._id}`}>
        ...
        <div className="mt-1 flex gap-1 sm:gap-4 flex-wrap text-[11px] text-neutral-content">
          <p>{modelTest?.category?.name}</p>
          <p className="flex items-center gap-1">
            <FaUsers />
            {modelTest?.participated} participated
          </p>
          <p>Vendor: {modelTest?.vendor?.profile?.name}</p>
        </div>
