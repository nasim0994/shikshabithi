...
import { useAddExamModelTestMutation } from "../../../../Redux/api/academy/academyModelTestApi";
...
export default function AddModelTest() {
  ...
  const [addExamModelTest, { isLoading }] = useAddExamModelTestMutation();
  ...
  const handleAdd = async (e) => {
    ...
    let res = await addExamModelTest(info);
