...
import { useAddJobModelTestMutation } from "../../../../Redux/api/job/jobModelTestApi";

export default function AddJobModelTest() {
  ...
  const [addJobModelTest, { isLoading }] = useAddJobModelTestMutation();
  ...
  const handleAdd = async (e) => {
    ...
    let res = await addJobModelTest(info);
  ...
  return (
    <div className="bg-base-100 shadow rounded">
      <div className="border-b p-3">
        <h3 className="font-medium">Add Model Test</h3>
      </div>
